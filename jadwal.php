...
<table border="1" align="center" width="60%">
  ...
  while ($hasil=mysqli_fetch_array($tampil)){
    ...
    <tr bgcolor="white" style="color: black" align="center">
      ...
      <td>
        <a href="edit_jadwal.php?id=<?php echo $hasil['id'];?>" class="btn btn-primary btn block">edit</a>|
        <a href="hapus_jadwal.php?hapus&id=<?=$hasil['id'];?>" class="btn btn-danger btn block">hapus</a>
      </td>
    </tr>
    <?php
  }
