...
<body>
  ...
  style="background-image: url('https://images.pexels.com/videos/7234900/4k-abstract-abstract-background-antique-7234900.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500');">
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h5 class="text-uppercase text-center mb-5">please enter username and password</h5>
              <form>
