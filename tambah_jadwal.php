...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  ...
  <a class="navbar-brand" href="jadwal.php">Jadwal Hari Ini</a>
      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Tambah Jadwal</h3>
            ...
            <form class="px-md-2">
              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline datepicker">
                    <input type="text" name="hari" class="form-control" required style="width: 440px" />
              ...
              <div class="row mb-4 pb-2 pb-md-0 mb-md-5">
                <div class="col-md-6">
                 ...
                 <div class="form-outline datepicker">
                    <input type="text" name="kelas" class="form-control" required style="width: 440px" />
               ...
               <div class="row mb-4 pb-2 pb-md-0 mb-md-5">
                <div class="col-md-6">
                 ...
                 <div class="form-outline datepicker">
                    <input type="time" name="jam" class="form-control" required style="width: 440px" />
